    ...
    <form action="" method="POST">
        <table>
            <tr>
                <td>メールアドレス</td>
                <td>
                    <input type="email" name="email" placeholder="xxxxx@xxxxx">
            ...
            <tr>
                <td>お名前*</td>
                <td>
                    <input type="text" name="membername" required placeholder="電子太郎">
            ...
            <tr>
                <td>郵便番号*</td>
                <td>
                    <input type="text" name="zipcode" pattern="\d{3}-\d{4}" title="郵便番号は3桁-4桁でハイフン(-)を入れて入力してください" placeholder="xxx-xxxx">
            ...
            <tr>
                <td>住所</td>
                <td>
                    <input type="text" name="address" placeholder="新宿区xxxx">
